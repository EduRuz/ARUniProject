...
void MenuState::init(gef::AudioManager* audioManager_, gef::InputManager* inputManager_, gef::SpriteRenderer* spriteRenderer_, class gef::Renderer3D* renderer3d_, bool vita)
{
...
void MenuState::update(float fps)
{
	camera.update();
...
void MenuState::render(float fps, gef::Font * font_)
{
